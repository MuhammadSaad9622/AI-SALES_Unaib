...
document.addEventListener("DOMContentLoaded", () => {
          ...
          (response) => {
            ...
            if (meeting) {
              ...
              <div class="meeting-details">
                ...
                ${
                  !response.currentMeeting
                    ? '<p class="meeting-tip">Meeting detected but not initialized. Try refreshing the page.</p>'
                    : ""
                }
              </div>
            `;
    ...
    if (userData && userInfoElement) {
      userInfoElement.innerHTML = `
        <div class="user-avatar">
          <img src="${userData.avatarUrl || "icons/default-avatar.svg"}" alt="${
        userData.name || "User"
      }">
        </div>
  ...
  function updateStatusIndicator() {
    if (statusIndicator) {
      statusIndicator.className = isTranscribing
        ? "status-indicator active"
        : "status-indicator";
      statusIndicator.title = isTranscribing
